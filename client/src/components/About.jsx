        ...
        >
            <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
                ...
                <p className="text-xl">
                    ...
                    Django, SQL, and MongoDB, and software automation with
                    Selenium, PyAutoGui, Microsoft Power Automate, and Simulink.
                    I am also proficient in various software testing libraries,
                    including Pytest, Unittest, and JUnit.
                </p>
                <br />
                <p className="text-xl">
